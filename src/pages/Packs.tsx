  ...
  return (
    <>
      <Seo
        ...
        description="Consulta los tipos de reserva: mañana, tarde o día completo. Espacio exclusivo para hasta 49 personas en Sevilla. Desde solo 85 €. ¡Fácil y rápido!"
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="border rounded-lg p-8 bg-white shadow-lg hover:shadow-xl transition-shadow">
                <h3 className="text-2xl font-bold mb-4 text-[#20c997]">
                  Horario Mañana
                </h3>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    ...
                    <span>
                      <b>Horario:</b> 10:00 h a 15:00 h
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Clock className="h-5 w-5 text-[#20c997] mr-2" />
                    <span>
                      <b>Duración:</b> 5 horas de diversión
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Users className="h-5 w-5 text-[#20c997] mr-2" />
                    <span>
                      <b>Capacidad:</b> 49 personas
                    </span>
                  </li>
              ...
              <div className="border rounded-lg p-8 bg-[#20c997] text-white shadow-lg hover:shadow-xl transition-shadow transform scale-105">
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    ...
                    <span>
                      <b>Horario:</b> 10:00 h a 22:00 h
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Clock className="h-5 w-5 text-white mr-2" />
                    <span>
                      <b>Duración:</b> 13 horas de diversión
                    </span>
                  </li>
                  <li className="flex items-center">
              ...
              <div className="border rounded-lg p-8 bg-white shadow-lg hover:shadow-xl transition-shadow">
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    <CalendarClock className="h-5 w-5 text-[#20c997] mr-2" />
                    <span>
                      <b>Horario:</b> 16:00 h a 21:00 h ó 17:00 h a 22:00 h
                    </span>
                  </li>
                  <li className="flex items-center">
                    <Clock className="h-5 w-5 text-[#20c997] mr-2" />
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Con capacidad para 49 personas, equipado con mesas, sillas y
                    taburetes. Perfecto para cualquier tipo de celebración.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Parque de bolas de 40 m² con cama elástica, piscina de bolas
                    con tobogán y dos niveles. Incluye una pista de fútbol
                    infantil para jugar en un entorno seguro.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800">
                    Área para los Más Peques
                  </h3>
                  <p className="text-gray-700">
                    Espacio con cocinita, cochecitos y juguetes que estimulan la
                    imaginación de los más chiquitines.
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800">
                    Zona Gamer (Adolescentes y Adultos)
                  </h3>
                  <p className="text-gray-700">
                    Dos máquinas árcade con más de 3000 juegos clásicos, diana y
                    futbolín. ¡Diversión asegurada para todas las edades!
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Equipada con nevera, cafetera Dolce Gusto, microondas y
                    botellero. Todo listo para preparar o conservar alimentos y
